...
void text()
{
    ...
    glColor3f(1,1,1);
    drawstring(160,130,0.0,"SIET BUS");
    glColor3f(1,1,1);
}
...
void credit()
{
    setFont(GLUT_BITMAP_HELVETICA_18);
    glColor3f(1,1,1);
    drawstring(5,55,0.0,"ALERT SIGNALING SYSTEM");
    glColor3f(1,1,1);
    drawstring(5,55,0.0,"Developed By: RAVINDRA H V");
    glColor3f(1,1,1);
    drawstring(5,30,0.0,"USN: 1SV19CS057");
    glColor3f(1,1,1);
    drawstring(5,5,0.0,"CSE, SIET");
    glColor3f(1,1,1);
    drawstring(5,5,0.0,"GUIDE: Mr.Renukaradhya P.C");
}
...
void msg()
{
    setFont(GLUT_BITMAP_HELVETICA_18);
    glColor3f(1,1,1);
    drawstring(5,30,0.0,"This system can alert pedestrian in two way lane also.");
    glColor3f(1,1,1);
    drawstring(5,10,0.0,"That means it can detect  vehicles.");
...
void developer()
{
    setFont(GLUT_BITMAP_HELVETICA_18);
    glColor3f(1,1,1);
    drawstring(200,355,0.0,"ALERT SIGNALING SYSTEM");
    glColor3f(1,1,1);
    drawstring(200,315,0.0,"Developed By: RAVINDRA H V");
    glColor3f(1,1,1);
    drawstring(200,275,0.0,"USN: 1SV19CS057");
    glColor3f(1,1,1);
    drawstring(200,235,0.0,"CSE, SIET");
}
...
void endmsg()
{
    setFont(GLUT_BITMAP_HELVETICA_18);
    glColor3f(1,1,1);
    drawstring(200,355,0.0,"Fast drive could be the last drive. Be Safe and Happy");
    glColor3f(1,1,1);
...
void subtitle2()
{
    ...
    glColor3f(1,1,1);
    drawstring(5,30,0.0,"So that people can easily walk without any chaos.");
}
...
void MyTimerFunc(int value)
{
   if (value == 0) // passed in in main
   {
      ...
      // Change to a new display function in 20 seconds
   ...
   else if(value==1)
   {
     ...
     glutIdleFunc(display);
      //switching display after 30 seconds
     glutTimerFunc(30000, MyTimerFunc, 2);
   }
    else if(value==2)
   {
     ...
     //switching display after 30 seconds
     glutTimerFunc(30000, MyTimerFunc, 3);
    ...
    else if(value==3)
   {
     ...
     //switching display after 30 seconds
     glutTimerFunc(30000, MyTimerFunc, 4);
